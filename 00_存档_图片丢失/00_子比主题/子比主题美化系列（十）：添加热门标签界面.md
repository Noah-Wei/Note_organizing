...
![image-20230709181551412](https://lskypro-1309218011.cos.ap-shanghai.myqcloud.com/2023/07/09/64aa88d90cab1.png)

## 使用教程

### 1、创建hot_togs.php文件

**在pages目录下创建一个`hot_togs.php`文件，完整路径应该是`站点.com/wp-content/themes/zibll/pages`：**
...
**进入到后台—>页面—>新建页面—->选择热门标签页面即可使用。**

![image-20231013160127142](https://lskypro-1309218011.cos.ap-shanghai.myqcloud.com/2023/10/13/6528f958ba041.png)

![image-20231013160143493](https://lskypro-1309218011.cos.ap-shanghai.myqcloud.com/2023/10/13/6528f968e83c5.png)