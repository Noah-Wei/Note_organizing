# 子比主题美化系列（十九）： 侧边栏人生倒计时工具

## 前言

很多网站都会看到这个人生倒计时，这个html代码可以运用到多个网站程序

## 效果展示

![image-20231013192818741](https://lskypro-1309218011.cos.ap-shanghai.myqcloud.com/2023/10/13/652929d3a89b7.png)
...
<body>
    ...
    <div class="reviews-container">
        <div class="m-3"><h3 class="text-center"> 人生倒计时</h3></div>
...
例：`https://www.kabll.com/rsdjs.html`

### 4、启动小工具

打开自己后台-小工具-自定义html，然后把放置到你想放到的地方，然后将以下代码放到自定义小工具里面

> 注：修改其中的src，切换成自己的文件路径

```html
<iframe src="https://www.kabll.com/rsdjs.html" frameborder="0" scrolling="no" style="margin-left:10px; margin-top:5px; width:400px; height:300px;"></iframe>
```